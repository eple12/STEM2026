...
BRAKE_RISK_SENSOR_INDEX = 0                     #front sensor index (0 = top/front)
BRAKE_RISK_DISTANCE = 0.55                      #sensor value in [0,1], higher means closer obstacle
BRAKE_RISK_SPEED = 0.45                         #normalized speed threshold in [0,1]
BRAKE_MISS_PENALTY = 0.50                       #penalty when risky and not braking
BRAKE_USE_REWARD = 0.10                         #reward when risky and braking
